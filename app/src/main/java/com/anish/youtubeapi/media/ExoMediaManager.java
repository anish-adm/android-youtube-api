...
public class ExoMediaManager {
    ...
    private static ExoMediaManager mInstance = null;
    ...
    private ExoMediaManager(Context mContext) {
    ...
    /**
     * Return ExoMediaManager instance
     * @param mContext
     * @return
     */
    public static ExoMediaManager getSharedInstance(Context mContext) {
        if (mInstance == null) {
            mInstance = new ExoMediaManager(mContext);
        }
        return mInstance;
    }
